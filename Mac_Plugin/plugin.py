...
class Mac(Screen,ConfigListScreen):
    skin="""
        <screen position="center,center" size="500,200" title="MAC CHANGER BY Asghar Ali" backgroundColor="#31000000" flags="wfNoBorder">
            <widget name="config" position="10,10" size="440,200" zPosition="1" transparent="0" backgroundColor="#31000000" scrollbarMode="showOnDemand" />
        </screen>"""
...
def Plugins(**kwargs):
	return PluginDescriptor(
			name="MAC",
			description="mac changer by Asghar Ali",
